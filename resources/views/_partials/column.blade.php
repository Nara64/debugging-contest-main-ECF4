...
<div class="flex flex-col gap-2 py-5 px-4 bg-white">
    ...
    <div x-data="{ openModale: false }" @click="openModale = true" class="p-2 rounded shadow-md border bg-white hover:bg-gray-50 hover:shadow-xl transition-all duration-200 cursor-pointer">
